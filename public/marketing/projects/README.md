...
- `keyboard-social.webp`: promotional artwork generated September 20, 2026 for keyboardlayout.app, featuring Q/D/C keycaps and “Try a different way to type.” Reuses the site’s social share artwork, fitted to 1280×720 without cropping. The generation prompt is in the keyboard-layout repository at `docs/social-image.md`. Used in the current Gallery.
